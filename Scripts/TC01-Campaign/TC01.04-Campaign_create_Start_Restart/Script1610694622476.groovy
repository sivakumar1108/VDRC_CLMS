...
WebUI.setText(findTestObject('TC01-Campaign/04_Campaign(config_manager)/Customer_contact_Campaign/06_01_Input_text_Campaign_Name'), 
    GlobalVariable.campaignnameTC01_04)
...
WebUI.click(findTestObject('TC01-Campaign/04_Campaign(config_manager)/Customer_contact_Campaign/06_19_Click_Start Campaign_button_to_start_the_campaign'))
...
WebUI.takeFullPageScreenshot('Screenshots/Screenshots_CLMS/TC01.04_01_After_starting_the_campaign.png')

WebUI.click(findTestObject('TC01-Campaign/04_Campaign(config_manager)/Customer_contact_Campaign/06_20_Click_Pause_campaign'))
...
WebUI.takeFullPageScreenshot('Screenshots/Screenshots_CLMS/TC01.04_02_After_Pausing_the_campaign.png')

WebUI.delay(5)

WebUI.click(findTestObject('TC01-Campaign/04_Campaign(config_manager)/Customer_contact_Campaign/06_21_Click_Restart_the_campaign'))

WebUI.delay(5)

Campaignrestart = WebUI.getAlertText()
...
WebUI.takeFullPageScreenshot('Screenshots/Screenshots_CLMS/TC01.04_03_After_Restarting_the_campaign.png')

WebUI.comment(Campaignrestart)

WebUI.comment('New campaign is created and started and paused and restarted the campaign successfully.')
