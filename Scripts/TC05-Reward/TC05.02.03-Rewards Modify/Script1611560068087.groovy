...
WebUI.setText(findTestObject('TC05-Rewards/Page_Emagine Administration Application 11.5.0/03_01_Input_Reward_search_input'), 
    GlobalVariable.reward_dup_name)
...
WebUI.click(findTestObject('TC05-Rewards/Page_Emagine Administration Application 11.5.0/11_Click_MODIFY_button'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(5)

WebUI.setText(findTestObject('TC05-Rewards/Page_Emagine Administration Application 11.5.0/08_02_Input_Reward_Name'), GlobalVariable.reward_mod_name)

WebUI.selectOptionByIndex(findTestObject('TC05-Rewards/Page_Emagine Administration Application 11.5.0/08_04_Drop_Supplier_Name'), 
    1)
...
WebUI.takeFullPageScreenshot('Screenshots/Screenshots_CLMS/TC05.02.03-Rewards_After_modified.png')
